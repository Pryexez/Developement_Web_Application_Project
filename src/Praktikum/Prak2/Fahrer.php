...
EOT;
    ...
    echo <<<EOT
    <form id = "driver_form1" action="./Fahrer.php" method="post" accept-charset="UTF-8">
    <label for = "input1_finished">Fertig</label>
    <input type = "radio" name = "order_radio" value = "ready" id = "input1_finished" $checked[2]>
    <label for = "input1_driving">Unterwegs</label>
    <input type = "radio" name = "order_radio" value = "driving" id = "input1_driving" $checked[3]>
    <label for = "input1_delivered">Geliefert</label>
    <input type = "radio" name = "order_radio" value = "delivered" id = "input1_delivered">
